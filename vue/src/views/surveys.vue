        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
            ...
            >
                ...
                <div class="flex justify-between items-center mt-3">
                    ...
                    class="flex py-2 px-4 border border-translate text-sm rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                    ...
                    class="h-8 w-8 flex items-center justify-center border border-transparent text-sm rounded-full text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                    >
